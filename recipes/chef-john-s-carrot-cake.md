...
description: "This medium-level dessert features all-purpose flour, salt and is ready in about 55 minutes. Serves 12."
author: "Chef John"
prep_time: PT15M
cook_time: PT40M
servings: 12
...
tools:
  ...
  - Baking Dish
skill_level: Medium
source_url: "https://www.allrecipes.com/recipe/263516/chef-johns-carrot-cake/"
---
...
### How long does it take to make Chef John's Carrot Cake?
...
### How many servings does this Chef John's Carrot Cake recipe make?

This recipe yields 12 servings. You can adjust the serving size using the servings slider above the ingredient list.

### Can I make Chef John's Carrot Cake ahead of time? How should I store leftovers?

Store leftover chef john's carrot cake in an airtight container in the refrigerator for up to 3-4 days.

### How many calories are in Chef John's Carrot Cake?

Each serving contains approximately 728 calories. The recipe serves 12.

### What temperature should I use for Chef John's Carrot Cake?
