...
description: "A delicious dessert made with all-purpose flour, unsweetened cocoa powder. Ready in about 1 hour and 10 minutes and serves 10."
author: "Tahoura Hashemi"
prep_time: PT40M
cook_time: PT30M
servings: 10
calories: 820
...
tools:
  ...
  - Whisk
skill_level: Hard
source_url: "https://www.allrecipes.com/recipe/272783/red-velvet-strawberry-cake/"
---
...
1. Preheat the oven to 350 degrees F (175 degrees C). Lightly grease two 9-inch cake pans and sprinkle with flour if pans don't have a smooth bottom.
...
4. Beat in egg yolks, vanilla extract, vinegar, and enough food coloring to reach desired color. Pour in flour mixture, alternating with buttermilk, on low speed until just incorporated, making sure to not overmix the batter.
...
### How long does it take to make Red Velvet Strawberry Cake?
...
### How many servings does this Red Velvet Strawberry Cake recipe make?

This recipe yields 10 servings. You can adjust the serving size using the servings slider above the ingredient list.

### Can I make Red Velvet Strawberry Cake ahead of time? How should I store leftovers?

Store leftover red velvet strawberry cake in an airtight container in the refrigerator for up to 3-4 days.

### How many calories are in Red Velvet Strawberry Cake?

Each serving contains approximately 820 calories. The recipe serves 10.

### What temperature should I use for Red Velvet Strawberry Cake?
