---
title: "Hasenpfeffer (Rabbit Stew)"
description: "Ready in about 2 hours, this soup uses rabbit meat, salt. Serves 4 at 767 calories each."
author: "Lovesmurfs"
prep_time: PT30M
cook_time: PT1H30M
servings: 4
...
tools:
  ...
  - Colander
skill_level: Hard
source_url: "https://www.allrecipes.com/recipe/25843/hasenpfeffer-rabbit-stew/"
---
...
### How long does it take to make Hasenpfeffer (Rabbit Stew)?
...
### How many servings does this Hasenpfeffer (Rabbit Stew) recipe make?

This recipe yields 4 servings. You can adjust the serving size using the servings slider above the ingredient list.

### Can I make Hasenpfeffer (Rabbit Stew) ahead of time? How should I store leftovers?

This soup stores well in the refrigerator for 4-5 days. It also freezes well for up to 3 months.

### How many calories are in Hasenpfeffer (Rabbit Stew)?

Each serving contains approximately 767 calories. The recipe serves 4.
