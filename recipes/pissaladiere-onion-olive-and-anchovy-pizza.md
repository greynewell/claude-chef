---
title: "Pissaladiere (Onion, Olive, and Anchovy Pizza)"
description: "A delicious main course made with all-purpose flour, salt. Ready in about 1 hour and 45 minutes and serves 6."
author: "Charlie_One"
prep_time: PT20M
cook_time: PT1H25M
servings: 6
...
tools:
  ...
  - Food Processor
skill_level: Medium
source_url: "https://www.allrecipes.com/recipe/283769/pissaladiere-onion-olive-and-anchovy-pizza/"
---
...
### How long does it take to make Pissaladiere (Onion, Olive, and Anchovy Pizza)?
...
### How many servings does this Pissaladiere (Onion, Olive, and Anchovy Pizza) recipe make?

This recipe yields 6 servings. You can adjust the serving size using the servings slider above the ingredient list.

### Can I make Pissaladiere (Onion, Olive, and Anchovy Pizza) ahead of time? How should I store leftovers?

Store leftovers in an airtight container in the refrigerator for up to 3-4 days.

### How many calories are in Pissaladiere (Onion, Olive, and Anchovy Pizza)?

Each serving contains approximately 380 calories. The recipe serves 6.

### What temperature should I use for Pissaladiere (Onion, Olive, and Anchovy Pizza)?
